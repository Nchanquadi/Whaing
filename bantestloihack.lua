...
u.Image = "rbxassetid://16719725107"
...
function LoadSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("MinGamingHub") then
			makefolder("MinGamingHub")
		end;
		if not isfolder("MinGamingHub/Blox Fruits/") then
			makefolder("MinGamingHub/Blox Fruits/")
		end;
		if not isfile("MinGamingHub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			writefile("MinGamingHub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
		else
			local x = game:GetService("HttpService"):JSONDecode(readfile("MinGamingHub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
...
function SaveSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfile("MinGamingHub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			...
			writefile("MinGamingHub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(A))
		end
	else
		return
	end
		...
		game:GetService("RunService").Stepped:Connect(function()
			if _G.AutoFarm or _G.TptoKisuneIsland or _G.TptoEventIsland or _G.TptoKisuneshrine or _G.ColletEmber or _G.NeareastFarm or _G.Mirage or _G.AutoEvent or _G.Auto_Gear or _G.TeleportGear or _G.AutoNewWorld or _G.AutoSaber or _G.AutoPole or _G.TeleportIsland or _G.AutoThirdSea or _G.AutoBartiloQuest or _G.Auto_Evo_Race_V2 or _G.AutoDarkCoat or _G.AutoSwanGlasses or _G.AutoTrueTriplKatana or _G.AutoRengoku or _G.AutoEctoplasm or _G.AutoFactory or _G.AutoRainbowHaki or _G.AutoEliteHunter or _G.AutoCastleRaid or _G.AutoMusketeerHat or _G.AutoBuddySword or _G.AutoFarmBone or _G.AutoKenHakiV2 or _G.AutoObservation or _G.AutoGodHuman or _G.AutoCavander or _G.AutoCursedDualKatana or _G.AutoYamaSword or _G.AutoTushitaSword or _G.AutoSerpentBowor or _G.AutoDarkDagger or _G.AutoCakePrince or _G.AutoDoughV2 or _G.AutoHolyTorch or _G.AutoBuddySwords or _G.AutoFarmBossHallow or _G.TPTOBOAT or Tushita_Quest2 or Tushita_Quest1 or AutoFarmMaterial or teleporttop or _G.AutoFarmChest or _G.AutoAllBoss or _G.AutoBossSelect or _G.AutoFarmBoss or _G.AutoFarmFruitMastery or _G.AutoFarmGunMastery or _G.FarmMasterySwordList or _G.AutoRaids or _G.AutoNextPlace or Auto_Kill_Law or _G.Auto_Kill_Players_Nearby then
				...
				if not game.Players.LocalPlayer.Character:FindFirstChild("Highlight") then
					...
					_.FillColor = Color3.new(38, 235, 12)
					_.OutlineColor = Color3.new(38, 235, 12)
...
_G.Color = Color3.fromRGB(38, 235, 12)
if _G.Mode == nil then
	_G.Mode = "Th"
end;
...
function bm:Window(d, br, bs)
	...
	bM.Text = "MinGaming Hub"
	bM.TextColor3 = Color3.fromRGB(38, 235, 12)
	bM.TextSize = 18.000;
	bM.TextWrapped = true;
	local bS = {}
...
Vec("<Color=Green>MinGaming Hub Load Finish<Color=/>")
dm:Seperator("⚙️")
Weapon = {
	"Melee",
	"Sword",
...
spawn(function()
      ...
      if _G.WhiteScreen then
        ...
        dm:Toggle("White Screen",_G.WhiteScreen,function(value)
				...
				if game.Players.LocalPlayer.Character:FindFirstChild("Superhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Superhuman") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Black Leg") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Death Step") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Fishman Karate") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Sharkman Karate") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Sharkman Karate") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electro") or game.Players.LocalPlayer.Character:FindFirstChild("Electro") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electric Claw") or game.Players.LocalPlayer.Character:FindFirstChild("Electric Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Claw") or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Dragon Talon") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Dragon Talon") or game.Players.LocalPlayer.Character:FindFirstChild("Godhuman") or game.Players.LocalPlayer.Backpack:FindFirstChild("Godhuman") then
					if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman", true) == 1 then
						...
						game.StarterGui:SetCore("SendNotification", {
							...
							Icon = "http://www.roblox.com/asset/?id=16719725107",
							Duration = 2.5
						})
					end;
...
dq:Seperator("✨")
_G.HealthMs = 25;
dq:Toggle("Auto Farm MasteryGun {Click the mouse to shoot}", _G.Settings.AutoFarmGunMastery, function(value)
...
dq:Toggle("Auto Farm MasteryFruit", _G.Settings.AutoFarmFruitMastery, function(value)
...
dq:Slider("Kill At (%)", 1, 100, 25, function(value)
	_G.HealthMs = value
end)
dq:Label("Skill List")
dq:Toggle("Skill Z", _G.SkillZ, function(value)
	_G.SkillZ = value
end)
dq:Toggle("Skill X", _G.SkillX, function(value)
	_G.SkillX = value
end)
dq:Toggle("Skill C", _G.SkillC, function(value)
	_G.SkillC = value
end)
dq:Toggle("Skill V", _G.SkillV, function(value)
	_G.SkillV = value
end)
dq:Toggle("Skill F", _G.SkillF, function(value)
	_G.SkillF = value
end)
...
dx:Seperator("🏝️")
dx:Toggle("Teleport To Mirage Island", _G.Settings.AutoMirageIsland, function(value)
	_G.Mirage = value;
...
dx:Toggle("Teleport To Mirage Island{Hop}", _G.Settings.MirageHop, function(value)
	_G.MirageHop = value;
...
dx:Toggle("ESP Mirage Island", _G.ESPMirageIsland, function(value)
	_G.ESPMirageIsland = value;
	ESPMirageIsland()
end)
dx:Toggle("Teleport To Advanced Fruit Dealer", _G.TPNPCDF, function(value)
	spawn(function()
		pcall(function()
			while wait() do
				if _G.TPNPCDF then
...
dx:Toggle("Teleport To Gear", _G.Settings.Auto_Gear, function(value)
	_G.Auto_Gear = value;
...
dx:Toggle("Lock Moon", _G.LockMoon, function(value)
	_G.LockMoon = value;
	LockMoon()
end)
dw:Seperator("🐰")
...
dw:Toggle("Kill Player After Trial!",false,function(value)
